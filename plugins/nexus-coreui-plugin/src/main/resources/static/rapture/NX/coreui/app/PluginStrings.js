...
Ext.define('NX.coreui.app.PluginStrings', {
  ...
  keys: {
    ...
    Repository_Facet_AptFacet_Origin_HelpText: 'Repo origin field, leave blank if not sure',
    Repository_Facet_AptFacet_Label_FieldLabel: 'Label',
    Repository_Facet_AptFacet_Label_HelpText: 'Repo label field, leave blank if not sure',
